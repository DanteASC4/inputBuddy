...
<section
  class="mt-4 rounded-2xl border border-neutral-200 bg-white/80 p-4 shadow-sm"
>
  ...
  <input
    class="mt-3 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-xs"
